                  ...
                  <!--   Kitchen Sink -->
                    <div class="panel panel-default">
                        <div class="panel-heading">
							...
							<h3 align="center">Laporan Pendapatan Semua Kamar</h3>
							</br>
                        </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover">
									...
									<?php
										...
										$minimal = array();
										$maximal = array();
										$sqlquery = "SELECT transaksi.*, orang.*, kamar.* FROM transaksi transaksi INNER JOIN orang orang ON transaksi.id_orang = orang.id_orang INNER JOIN kamar kamar ON transaksi.kode_kamar = kamar.kode_kamar ORDER BY transaksi.id_orang ASC";
										if ($result = mysqli_query($koneksi, $sqlquery)) {
											...
											$minimal[] = $total_tagihan;
											$maximal[] = $total_tagihan;
									...
									?>
                                        <tr>
											...
											<tr>
											<td colspan='8'>Minimal</td>
											<td colspan='2'><?php echo rupiah(min($minimal)); ?></td>
											</tr>
											<tr>
											<td colspan='8'>Maksimal</td>
											<td colspan='2'><?php echo rupiah(max($maximal)); ?></td>
											</tr>
											<?php
